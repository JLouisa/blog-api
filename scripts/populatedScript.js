...
async function popBlogs() {
  ...
  await Promise.all([
    blogCreate(
      ...
      "In the quiet hours of the night, she quietly crept into the kitchen, her steps as soft as a whisper. The moonlight painted a gentle silver glow across the room, casting long shadows that danced in harmony with her graceful movements. In her delicate hands, she held a ripe red apple, its skin glistening with temptation. As I slumbered, blissfully unaware of her secret mission, she took a decisive bite from the fruit. Its crisp, juicy flesh yielded to her hunger, and for a moment, the world seemed to pause. The taste of the apple was both sweet and tart, a perfect contradiction, just like the love that bound us. But her culinary adventure didn't end there. With the apple now a part of her, she embarked on a journey to create something special. In the stillness of the night, she transformed the stolen fruit into a warm, fragrant pie. The aroma of freshly baked apples and cinnamon filled our home, a scent that would forever be etched in my memory. When morning arrived, she served me a slice of that apple pie, its golden crust glistening with a hint of mischief. Oblivious to the apple's earlier indiscretion, I savored the slice, each bite a delightful surprise. The flavors were exquisite, a testament to her culinary prowess. It wasn't until later that I discovered the truth, the secret she had harbored in the shadows of the night. By then, it hardly mattered. Love, I realized, is about the imperfections and surprises, the moments that catch us off guard and bring us closer. Our relationship was a journey, one filled with both the sweet taste of pie and the bittersweet bite of an apple eaten in the dark. And in that moment of revelation, I couldn't help but smile. She was more than just the apple thief of the night; she was my partner in life, my confidant, and my co-conspirator. We had pledged to stand together through the highs and the lows, for better and for worse, and this little adventure was just one of the many stories that bound our hearts together.",
      users[0],
      false
    ),
    blogCreate(
