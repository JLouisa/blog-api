exports.createMockDB = () => {
  ...
  db.users = [
    { username: "adamthefirst", password: "apple", isAdmin: false, isSuspended: false },
    { username: "eve", password: "apple", isAdmin: false, isSuspended: false },
    { username: "johndoe123", password: "12345", isAdmin: false, isSuspended: false },
    { username: "janesmith456", password: "password123", isAdmin: false, isSuspended: false },
  ];
